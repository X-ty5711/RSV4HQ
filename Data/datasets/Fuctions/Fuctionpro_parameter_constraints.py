...
def datainput(data_set,batch_size=20,step=5,maxh=5):
    ...
    train_iter = load_array((genFeaturesLabels(data_set[train_cases],step,maxh)), batch_size)
    test_iter = load_array((genFeaturesLabels(data_set[test_cases],step,maxh)), batch_size)
