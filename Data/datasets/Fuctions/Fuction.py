...
def datainput(data_set,batch_size=20):
    ...
    train_iter = load_array((genFeaturesLabels(data_set[train_cases])), batch_size)
    test_iter = load_array((genFeaturesLabels(data_set[test_cases])), batch_size)
